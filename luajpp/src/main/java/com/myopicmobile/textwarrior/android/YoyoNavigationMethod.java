...
public class YoyoNavigationMethod extends TouchNavigationMethod {
    ...
    public YoyoNavigationMethod(FreeScrollingTextField textField) {
        ...
        _yoyoSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, (float) (FreeScrollingTextField.BASE_TEXT_SIZE_PIXELS * 1.2), dm);
        _yoyoCaret = new Yoyo();
        _yoyoStart = new Yoyo();
        _yoyoEnd = new Yoyo();
    }
    ...
    public boolean onDown(MotionEvent e) {
        ...
        if (!_isCaretTouched) {
            ...
            _yoyoStart.setFocus(_isStartHandleTouched);
            _yoyoEnd.setFocus(_isEndHandleTouched);
    ...
    public void onTextDrawComplete(Canvas canvas) {
        if (!_textField.isSelectText2()) {
            ...
            if (!(_isStartHandleTouched && _isEndHandleTouched)) {
                ...
                _yoyoStart.setFocus(_textField.getSelectionStart() == _textField.getCaretPosition());
                ...
                _yoyoEnd.setFocus(_textField.getSelectionEnd() == _textField.getCaretPosition());
            }
    ...
    private class Yoyo {
        ...
        public void draw(Canvas canvas, boolean activated) {
            ...
            canvas.drawArc(new RectF(_anchorX - (radius * 2), _anchorY - radius - YOYO_STRING_RESTING_HEIGHT,
                    _handleX + (radius * 3), _handleY + radius), 60, 60, true, _brush);
        ...
        public void setFocus(boolean b) {
            ...
            if (mFocus)
                ...
                _brush.setColor(_textField.getColorScheme().getColor(Colorable.CARET_DISABLED));
