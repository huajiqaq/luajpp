...
public class LuaUtf8String extends LuaValue {
     ...
     * <p>
     * The resulting {@link LuaUtf8String} wraps the specified segment of the byte array.
     *
     ...
     * @see org.luaj.LuaString##encodeToUtf8(char[], int, byte[], int)
     * @see #isValidUtf8()
     */
    ...
    public LuaValue add(LuaValue rhs) {
        double d = scannumber();
        return Double.isNaN(d) ? arithmt(LuaConstants.ADD, rhs) : rhs.add(d);
    }
    ...
    public LuaValue sub(LuaValue rhs) {
        double d = scannumber();
        return Double.isNaN(d) ? arithmt(LuaConstants.SUB, rhs) : rhs.subFrom(d);
    }
    ...
    public LuaValue mul(LuaValue rhs) {
        double d = scannumber();
        return Double.isNaN(d) ? arithmt(LuaConstants.MUL, rhs) : rhs.mul(d);
    }
    ...
    public LuaValue pow(LuaValue rhs) {
        double d = scannumber();
        return Double.isNaN(d) ? arithmt(LuaConstants.POW, rhs) : rhs.powWith(d);
    }
    ...
    public LuaValue div(LuaValue rhs) {
        double d = scannumber();
        return Double.isNaN(d) ? arithmt(LuaConstants.DIV, rhs) : rhs.divInto(d);
    }
    ...
    public LuaValue mod(LuaValue rhs) {
        double d = scannumber();
        return Double.isNaN(d) ? arithmt(LuaConstants.MOD, rhs) : rhs.modFrom(d);
    }
    ...
    public LuaValue lt(LuaValue rhs) {
        return rhs.isstring() ? (rhs.strcmp(this) > 0 ? LuaConstants.TRUE : LuaConstants.FALSE) : super.lt(rhs);
    }
    ...
    public LuaValue lteq(LuaValue rhs) {
        return rhs.isstring() ? (rhs.strcmp(this) >= 0 ? LuaConstants.TRUE : LuaConstants.FALSE) : super.lteq(rhs);
    }
    ...
    public LuaValue gt(LuaValue rhs) {
        return rhs.isstring() ? (rhs.strcmp(this) < 0 ? LuaConstants.TRUE : LuaConstants.FALSE) : super.gt(rhs);
    }
    ...
    public LuaValue gteq(LuaValue rhs) {
        return rhs.isstring() ? (rhs.strcmp(this) <= 0 ? LuaConstants.TRUE : LuaConstants.FALSE) : super.gteq(rhs);
    }
    ...
    public LuaValue eq(LuaValue val) {
        return val.raweq(this) ? LuaConstants.TRUE : LuaConstants.FALSE;
    }
    ...
    public LuaValue tonumber() {
        double d = scannumber();
        return Double.isNaN(d) ? LuaConstants.NIL : valueOf(d);
    }
    ...
    private double scandouble(int start, int end) {
        ...
        if (end - start >= 0) System.arraycopy(m_bytes, start, c, 0, end - start);
        try {
    ...
    public LuaValue call(LuaValue arg) {
        if (arg instanceof LuaList && metatag(LuaConstants.CALL).isnil()) {
            ...
            int start = posrelat(arg.get(1).toint(), l);
            int end = posrelat(arg.get(2).toint(), l);
